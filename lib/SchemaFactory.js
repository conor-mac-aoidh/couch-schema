  ...
  for(i in ref){
    ...
    if(typeof ref[i] === 'object' && ref[i] !== null){
      ...
      // multiple documents, multiple types supported
        ...
        if(Object.prototype.toString.call(ref[i]) === '[object Array]' &&
          Object.prototype.toString.call(doc[k]) === '[object Array]'){
          res[k] = doc[k];
        }
        // if res is object and empty, copy
        else if(Object.keys(ref[k]).length === 0){
          res[k] = doc[k];
        }
